...
- **So is the third one.** `Pip` is a rendered character rather than an SVG —
  a small apprentice wizard in chibi proportions, with a floppy pointed hat, a
  staff with a lit orb, and a hat point that droops further the worse things
  are going. Chibi is not a shortcut: this figure is drawn between 36 and 112
  pixels wide, and realistic proportions put the face in about nine of them.
